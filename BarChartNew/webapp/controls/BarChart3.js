...
sap.ui.define(
    ...
    function (jQuery, Control) {
        ...
        var BarChartControl = Control.extend('sarath.controls.BarChart3', {
            metadata: {
                properties: {
        ...
        BarChartControl.prototype._createChart = function () {
				...
				var svg = d3.select(".SCBarChart").attr("width", width + margin.left + margin.right)
				...
				d3.tsv("../controls/data3.tsv", type, function(error, data) {
